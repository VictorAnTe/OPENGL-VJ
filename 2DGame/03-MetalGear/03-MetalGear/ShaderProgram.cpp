...
GLint ShaderProgram::bindVertexAttribute(const string& attributeName, GLint size, GLsizei stride, GLvoid* firstPointer)
{
	GLint attributePosition;

	attributePosition = glGetAttribLocation(programId, attributeName.c_str());
	glVertexAttribPointer(attributePosition, size, GL_FLOAT, GL_FALSE, stride, firstPointer);
